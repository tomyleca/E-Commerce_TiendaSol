...
const CardProducto = () => {
	...
	<div className="card">
		...
		<div className="tilt">
			<div className="img">
			<img src="https://images.unsplash.com/photo-1544237526-cae15a57ed1e?crop=entropy&cs=srgb&fm=jpg&ixid=M3wzMjM4NDZ8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NDkwNDY5NjB8&ixlib=rb-4.1.0&q=85" alt="Premium Laptop" />
			</div>
		<div className="info">
		...
		<button className="btn">
			<span role="button" onClick={() => agregar({ id: 1, title: 'UltraBook Pro X', price: 1999 })}>Agregar al carrito</span>
