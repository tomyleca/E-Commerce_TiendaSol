...
>>>>>>> d1b4bf66ab5eb0481bc9cc7e528d6825f23cba51
    };
        ...
        >
          <div className="form-section">
              ...
              >
                {categorias.map((c) => (
                  <MenuItem key={c._id || c.id} value={c._id || c.id}>
                    <Checkbox
                      checked={
                        producto.categoriasId.indexOf(c._id || c.id) > -1
                      }
                    />
                    <ListItemText primary={c.nombre || c.name} />
                  </MenuItem>
            ...
            <div>
              ...
              <ButtonGroup variant="outlined" aria-label="stock controls">
                <Button
                  onClick={() =>
                    setProducto((f) => ({
                      ...f,
                      stock: Math.max(0, Number(f.stock) - 1),
                    }))
                  }
                  disabled={Number(producto.stock) <= 0}
                >
                ...
                <Button
                  onClick={() =>
                    setProducto((f) => ({ ...f, stock: Number(f.stock) + 1 }))
                  }
                >
                  +
                </Button>
              ...
              {errores.stock && (
                <div mt={1} sx={{ color: "error.main", fontSize: "0.875rem" }}>
                  {errores.stock}
                </div>
              )}
            </div>
