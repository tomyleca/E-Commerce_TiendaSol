...
import { getProducto,getProductos,getCategorias } from '../../services/productService.js';
		...
		const cargarCategorias = async () => {
			const categoriasObtenidas = await getCategorias();
				...
				const toIdString = (val) => {
					...
					if (base == null) return "";
					if (typeof base === "string" || typeof base === "number") return String(base);
